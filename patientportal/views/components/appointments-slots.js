        ...
        return <div>
            ...
            <nav aria-label="Page navigation example">
                <ul className="pagination">
                    <li key={0} className={`page-item ${this.state.week <= 0 ? "disabled" : ""}`}><a className="page-link" onClick={()=>{this.setState.bind(this)({week: (this.state.week-1)%noWeeks})}}>Previous</a></li>
                    {this.pagination()}
                    <li key={3} className={`page-item ${this.state.week >= noWeeks - 1 ? "disabled" : ""}`}><a className="page-link" onClick={()=>{this.setState.bind(this)({week: (this.state.week+1)%noWeeks})}}>Next</a></li>
                </ul>
            </nav>

...
class AdminPanel extends React.Component {
    render() {
        return <div id={this.props.id} className="container btn-group-vertical">
                ...
                <button type="button" className="btn btn-primary btn-lg btn-block" onClick={()=>{window.location.href = "/admin/articles"}}>Appointment schedule</button>
...
ReactDOM.render(<AdminPanel id="admin-panel" title="Main menu"/>, document.getElementById('menu'));
class IndexNavigation extends React.Component {
    ...
    render(){
        return <div class="container btn-group-vertical">
                ...
                <button type="button" class="btn btn-primary btn-lg btn-block" onClick={()=>{window.location.href = "/contact"}}>Contact GP</button>
                <button type="button" class="btn btn-primary btn-lg btn-block" onClick={()=>{window.location.href = "/symptoms"}}>Symptom search</button>
